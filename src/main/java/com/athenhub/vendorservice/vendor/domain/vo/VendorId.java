...
/**
 * 업체 식별자(VendorId)를 표현하는 값 객체(Value Object).
 *
 ...
 *
 * <ul>
 *   <li>{@link #generateId()} — 신규 UUID 기반 VendorId 생성
 *   <li>{@link #of(UUID)} — 기존 UUID 값을 사용한 VendorId 생성
 * </ul>
 *
...
public class VendorId {
   ...
   * 새로운 업체 식별자를 생성한다.
   *
   * @return 신규 UUID 기반의 {@link VendorId}
   */
  public static VendorId generateId() {
